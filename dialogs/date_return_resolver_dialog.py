...
class DateReturnResolverDialog(CancelAndHelpDialog):
    """Resolve the date"""
    ...
    def __init__(
        ...
        super(DateReturnResolverDialog, self).__init__(
            dialog_id or DateReturnResolverDialog.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, DateReturnResolverDialog.datetime_prompt_validator
        )
    ...
    async def initial_step(
        ...
        prompt_msg = "when will the return ?"
        reprompt_msg = (
