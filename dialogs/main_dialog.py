...
class MainDialog(ComponentDialog):
    def __init__(
        ...
        # les deux lignes suivantes à mettre en commentaire
...
#        self.add_dialog(text_prompt)
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result is not None:
            ...
            msg_txt = f"I have you booked to {result.destination} from {result.origin} on {result.travel_date} return {result.return_date} with a budget of {result.budget} $"
